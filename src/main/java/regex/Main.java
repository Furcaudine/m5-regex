...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // Regex Explanation:
        // ^                : Start of string
        // (?=.*[a-z])      : Lookahead ensuring at least one lowercase letter
        // (?=.*[A-Z])      : Lookahead ensuring at least one uppercase letter
        // (?=.*[0-9])      : Lookahead ensuring at least one digit
    ...
    public static List<String> extractEmails(String str) {
        ...
        // Regex Explanation:
        // [^\\s@]+         : One or more characters that are NOT whitespace or '@' (User part)
        // @                : The literal '@' symbol
        // (mail\\.)?       : Optionally matches "mail."
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Regex Explanation:
        // .* : Any characters (start of string)
        // ([A-Z])          : Capture exactly one uppercase letter (Group 1)
        // .* : Any characters (in between)
        // \\1              : Backreference to Group 1 (must match the exact same letter captured)
        // .* : Any characters (rest of string)
